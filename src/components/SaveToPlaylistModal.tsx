      ...
      <div className="bg-black w-full max-w-[320px] rounded-2xl p-6 shadow-2xl ring-1 ring-white/10 relative z-10 flex flex-col">
        ...
        <div className="space-y-2 mb-6">
            ...
            <input 
                ...
                className="w-full bg-white text-black px-3 py-2 rounded text-sm outline-none focus:ring-2 focus:ring-purple-400 placeholder:text-gray-400 transition-all"
            />
        </div>

        <button 
            onClick={createPlaylist}
            className="w-full bg-[#a855f7] hover:bg-[#9333ea] text-black font-bold py-3 rounded-xl text-sm transition-all active:scale-[0.98]"
        >
            Create new Playlist
        </button>
      </div>
